...
│                         forestFiresML and configuration for tools like black
│
...
│
└── forestFiresML   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes forestFiresML a Python module
    │
